            ...
            <div className="flex flex-col w-full relative">
                ...
                <div className="fixed w-full z-10">
                    <nav className="bg-white flex items-center justify-between p-4">
                        ...
                        {/* 버튼에 메뉴바 아이콘 추가해야함 */}
                        <button type="button" onClick={NevMenu} className="bg-gray-200 rounded-xl w-8 h-8 mx-2"/>
                    </nav>
                    {isMenuOpen && (
                        <div className="w-full bg-white shadow-2xl z-10">
                            <ul className="flex flex-col p-4 space-y-8">
                                <li><a href="/Login" onClick={NevMenu} className="">공지사항</a></li>
                                <li><a href="#section1" onClick={NevMenu} className="">소개</a></li>
                                <li><a href="#section2" onClick={NevMenu} className="">시설</a></li>
                                <li><a href="#section3" onClick={NevMenu} className="">시간표</a></li>
                                <li><a href="#section4" onClick={NevMenu} className="">오시는길</a></li>
                ...
                <main className="w-full">
                    ...
                    <section id="section1" className="flex flex-col p-4">
                        ...
                        <div className="bg-white rounded-2xl w-full shadow-lg flex items-center flex-col">
                            <div className="w-full max-w-xs">
                                <div className="w-full max-w-xs overflow-hidden mt-4 mb-4 rounded-2xl">
                                    <Image src="/img/Profile01.jpg" alt="관장님 프로필" width={300} height={300} className="object-cover object-top w-full h-auto"/>
                                </div>
                        ...
                        <div className="card-face card-back bg-white text-black rounded-2xl w-full shadow-lg p-5 flex items-center flex-col mt-4">
                            <div className="w-full max-w-xs rounded-2xl overflow-hidden mt-4 mb-4">
                                <Image src="/img/Profile2.jpg" alt="관장님 프로필" width={300} height={300} className="object-cover object-top w-full h-auto"/>
                            </div>
                    ...
                    <section id="section2" className="flex flex-col items-start justify-start m-0 p-4">
                        ...
                        <div className="bg-white text-black rounded-2xl w-full shadow-2xl my-6 p-5 flex items-center flex-col">
                            <ImageSlider/>
                        </div>
                    </section>
                    ...
                    <section id="section3" className="flex flex-col items-start justify-start m-0 p-4">
                        ...
                        <div className="bg-white text-black rounded-2xl w-full shadow-lg flex items-center flex-col">
                            <div className="rounded-3xl bg-white">
                                <Image src="/img/Timetable.png" alt="운영 시간표" width={400} height={300} className="object-cover object-top w-full h-auto"/>
                            </div>
                        </div>
                    </section>
